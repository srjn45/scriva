...
/**
 * Generated from protobuf message <code>scriva.v1.AggregateRequest</code>
 */
class AggregateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .scriva.v1.AggregateOp aggregations = 5 [json_name = "aggregations"];</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Scriva\V1\AggregateOp::class);
