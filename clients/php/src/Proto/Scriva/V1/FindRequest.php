...
/**
 * Generated from protobuf message <code>scriva.v1.FindRequest</code>
 */
class FindRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .scriva.v1.OrderBy order_by_fields = 9 [json_name = "orderByFields"];</code>
     */
     ...
     *           (order_by_fields or the deprecated order_by); pass the same ordering, filter,
     *           and limit on every page. Combine with offset=0 for keyset paging.
     *     @type array<\Scriva\V1\OrderBy>|\Google\Protobuf\Internal\RepeatedField $order_by_fields
     *           Multi-field, per-field-directional sort (N3). When non-empty it supersedes
     *           the deprecated scalar order_by/descending. The record id is always the final
     *           tiebreaker, so the sort is total and pagination is stable.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .scriva.v1.OrderBy order_by_fields = 9 [json_name = "orderByFields"];</code>
     * @param array<\Scriva\V1\OrderBy>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOrderByFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Scriva\V1\OrderBy::class);
