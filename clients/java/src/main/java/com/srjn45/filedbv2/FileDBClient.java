 ...
 *
 * <p>A thin, ergonomic wrapper over the gRPC API defined in {@code proto/filedb.proto}.
...
public class FileDBClient implements AutoCloseable {
    ...
    /**
     * Translate a gRPC {@link StatusRuntimeException} into a typed FileDB
    ...
    /** Convert a proto {@link filedb.v1.Filedb.Record} into a {@link Record}. */
    static Record recordFromProto(filedb.v1.Filedb.Record r) {
